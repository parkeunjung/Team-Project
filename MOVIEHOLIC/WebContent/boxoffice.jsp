...
<%
	Date now = new Date();
	SimpleDateFormat format = new SimpleDateFormat("yyyyMMdd"); //format.format(now)

//	String y =  format.format(now);


	//파라메터 설정
	//조회일자
	String targetDt = request.getParameter("targetDt")==null?"20141202":request.getParameter("targetDt");
	//결과row수
...
<jsp:include page="Share/Header.jsp"/>
	<div class="content">
	<%out.println("오늘은 "+format.format(now)); %>
		<table border="1">
			<tr>
				<td>순위</td>
				<td>영화명</td>
